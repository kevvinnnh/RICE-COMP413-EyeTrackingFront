...
const PrepopulatedForm = () => {
    ...
    return (
        ...
        <div className="bg-white border-[1px] rounded-lg p-2 flex flex-col w-full mb-4">
        <label className="text-sm font-medium text-gray-700">
            What is the diagnosis for this skin lesion on the individual’s <em>back</em>?
        </label>
        <img
            // Replace with your path to image file 
            src="C:\Users\sophi\comp413\RICE-COMP413-EyeTrackingFront\src\components\dataverse_files.zip"
            className="my-4"
        />
